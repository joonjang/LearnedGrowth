...
### Gestures & Touchables
- Always prefer `Pressable`, `RectButton`, or `TouchableOpacity` from **react-native-gesture-handler**.
- Avoid core React Native touchables to prevent UI-thread conflicts.
