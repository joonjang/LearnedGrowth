...
const isReviewerEmail = (email: string) =>
   REVIEWER_EMAILS.has(normalizeEmail(email));
...
function normalizeProfile(
   ...
   return {
      ...
      lifetimeAiCalls: Number.isFinite(lifetime_ai_calls)
         ? lifetime_ai_calls
         : 0,
      ...
      const run = (async () => {
         ...
         try {
            const { error: cycleError } =
               await supabase.rpc('refresh_ai_cycle');
