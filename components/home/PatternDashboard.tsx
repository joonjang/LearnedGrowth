...
const PatternDashboard = React.memo(({ data, shadowSm, isDark }: Props) => {
   const [showHelp, setShowHelp] = useState(false);
   const [isPatternPressed, setIsPatternPressed] = useState(false);
   const patternSheetRef = useRef<BottomSheetModal | null>(null);
   ...
   const handlePatternPressOut = useCallback(() => {
      setIsPatternPressed(false);
   }, []);
   ...
   return (
      <View className="gap-4">
         ...
         {data.threePs && (
            <>
               <Pressable
                  onPress={handleOpenPatternSheet}
               ...
               >
                  <View
                     ...
                     style={[
                        shadowSm.ios,
                        shadowSm.android,
                        isPatternPressed && styles.cardPressed,
                     ]}
                  >
                     <View className="flex-row items-center justify-between mb-4">
                        ...
                        <Pressable onPress={handleToggleHelp}>
                           <View
                     ...
                     <View className="gap-6">
                        ...
                        <GradientSpectrumBar
                           ...
                           optimisticPercentage={
                              data.threePs.pervasiveness.score
                           }
                           isDark={isDark}
                        />
                        <GradientSpectrumBar
