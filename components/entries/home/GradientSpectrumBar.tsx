...
const GradientSpectrumBar = React.memo(
  ({ label, subLabel, leftLabel, rightLabel, optimisticPercentage, isDark }: Props) => {
    ...
    return (
      <View>
        ...
        <View className="h-2.5 w-full rounded-full overflow-hidden relative" style={{ backgroundColor: trackBg }}>
          <LinearGradient
        ...
        <View className="flex-row justify-between mt-1">
          <Text className="text-[9px] font-semibold" style={{ color: isDark ? '#34d399' : '#059669' }}>
            {leftLabel}
          </Text>
          <Text className="text-[9px] font-semibold" style={{ color: isDark ? '#f43f5e' : '#e11d48' }}>
            {rightLabel}
          </Text>
        </View>
      </View>
